...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.treeWidget.setStyleSheet(_fromUtf8("background:transparent;"))
        ...
        self.listWidget_2.setStyleSheet(_fromUtf8("background:transparent;"))
        ...
        self.plainTextEdit.setStyleSheet(_fromUtf8("background:transparent;"))
